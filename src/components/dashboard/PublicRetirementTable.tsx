...
import { usePublicRetirement } from "@/hooks/usePublicRetirement";

export default function PublicRetirementTable() {
  const { retirementData, jobTitlesSummary } = usePublicRetirement(10);
